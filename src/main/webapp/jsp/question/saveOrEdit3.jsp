...
<div id="${tabCode}_form_dialog">
	<form id="${tabCode}_form" method="post" >
		<input type="text" style="display:none;" name="type" value="3"/>
		<table>
			<tr>
				<td class="td_right">
					<span style="color:red;">*</span>题目：</td>
				<td class="td_left">
					<input type="text" id="${tabCode}_form_title" name="title" style="width:380px" value="${q.title}"/>
				</td>
			...
			<tr>
				<td class="td_right">
					<span style="color:red;">*</span>正确答案：</td>
				<td class="td_left">
					<input type="text" id="${tabCode}_form_opt_a" name="opt_a" style="width:380px" value="${q.opt_a}"/>
				</td>
				<td width="50"><span class="errorImg"></span><span class="errorMsg"></span></td>
			</tr>
		</table>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var dtitle = (("create"==new_or_edit)?"新建-简答题":"编辑-简答题")+"<label id=\""+FORM_PAGE_CONFIG.FORM_DIALOG+"_error\" class=\"error\" generated=\"true\" style=\"display:none;\"></label>";
