...
//	private String[] includeUrls = {};
	...
	// 不需要登陆过滤的地址
	private String[] excludeUrls = {"/test",".*css.*",".*images.*","/login","/logon","/logout","/validateCode","/toMofifyPasswordPage","/mofifyPassword","/pageToLogin","/ajaxCheckCodeValue","/swagger-ui.html"};
